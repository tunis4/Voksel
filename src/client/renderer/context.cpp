...
namespace render {
    ...
    void Context::create_image(VkImage *image, VmaAllocation *allocation, VmaAllocationInfo *alloc_info, u32 width, u32 height, VkFormat format, VkImageTiling tiling, VkImageUsageFlags usage, VmaAllocationCreateFlags alloc_flags) {
    ...
    void Context::transition_image_layout(VkImage image, VkImageLayout old_layout, VkImageLayout new_layout) {
        VkCommandBuffer command_buffer = begin_single_time_commands();
